...
Public Class stationServices
    ...
    Implements IImporter(Of stationService)
    Implements IDatabaseImporter(Of stationService)

    Public Const BaseFileName As String = "stationServices"
    ...
    ''' </summary>
    Public Function ImportFile() As Dictionary(Of Long, stationService) Implements IImporter(Of stationService).ImportFile

        FileNameErrorTracker = BaseFileName

        Return ImportJsonlFile(Of stationService)(SDEFilePath, Function(c) c._key)
    ...
    Public Sub InsertDatatoDatabase(Records As Dictionary(Of Long, stationService), ByVal Params As ImportParameters) _
        Implements IDatabaseImporter(Of stationService).InsertDatatoDatabase
        FileNameErrorTracker = BaseFileName
        ...
        For Each DataField In Records
            ...
            With DataField.Value
                ...
                DataFields.Add(UpdateDB.BuildDatabaseField("serviceName", GetTranslation(.serviceName, Params.ImportLanguageCode), FieldType.nvarchar_type))
...
Public Class stationService
    ...
    Public Property serviceName As TranslatedNameField
